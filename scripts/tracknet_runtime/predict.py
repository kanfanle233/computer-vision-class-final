...
if __name__ == '__main__':
    ...
    # CUDA benefits from worker prefetching; MPS/CPU is more robust without worker forks.
    num_workers = min(args.batch_size, 16) if device.type == 'cuda' else 0
    print(f'Use device: {device} (requested={args.device}, dataloader_workers={num_workers})')
